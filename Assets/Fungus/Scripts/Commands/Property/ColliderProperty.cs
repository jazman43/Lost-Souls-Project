                ...
                case GetSet.Get:
                    switch (property)
                    {
                        ...
                        case Property.ContactOffset:
                            ...
                            break;
                        case Property.HasModifiableContacts:
                            iob.Value = target.hasModifiableContacts;
                            break;
                        case Property.ProvidesContacts:
                            iob.Value = target.providesContacts;
                            break;
                        case Property.LayerOverridePriority:
                            ioi.Value = target.layerOverridePriority;
                            break;
                        default:
                ...
                case GetSet.Set:
                    switch (property)
                    {
                        ...
                        case Property.ContactOffset:
                            ...
                            break;
                        case Property.HasModifiableContacts:
                            target.hasModifiableContacts = iob.Value;
                            break;
                        case Property.ProvidesContacts:
                            target.providesContacts = iob.Value;
                            break;
                        case Property.LayerOverridePriority:
                            target.layerOverridePriority = ioi.Value;
                            break;
                        default:
                            Debug.Log("Unsupported get or set attempted");
                            break;
