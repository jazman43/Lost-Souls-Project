...
namespace Fungus
{
    ...
    public class TextureProperty : BaseVariableProperty
    {
                ...
                case GetSet.Get:
                    switch (property)
                    {
                        ...
                        case Property.TexelSize:
                            ...
                            break;
                        case Property.IsDataSRGB:
                            iob.Value = target.isDataSRGB;
                            break;
                        default:
        ...
        {
            if (textureData.textureRef == variable || inOutVar == variable)
                return true;
