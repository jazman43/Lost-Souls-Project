                ...
                case GetSet.Get:
                    switch (property)
                    {
                        ...
                        case Property.AttachedColliderCount:
                            ...
                            break;
                        case Property.TotalForce:
                            iov2.Value = target.totalForce;
                            break;
                        case Property.TotalTorque:
                            iof.Value = target.totalTorque;
                            break;
                        default:
                ...
                case GetSet.Set:
                    switch (property)
                    {
                        ...
                        case Property.Simulated:
                            ...
                            break;
                        case Property.TotalForce:
                            target.totalForce = iov2.Value;
                            break;
                        case Property.TotalTorque:
                            target.totalTorque = iof.Value;
                            break;
                        default:
                            Debug.Log("Unsupported get or set attempted");
                            break;
